import { enUS, ukUA, zhCN } from 'naive-ui'
...
export function i18nGet(key: string, named: Record<string, unknown> = {}): string {
...
export const i18nEnvManager = newI18nGet('envManager')
