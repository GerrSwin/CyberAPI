export default {
  collection: {
    ...
    curlPlaceholder: 'Paste the curl command (Windows/POSIX)',
    curlParseFail: 'Parse curl fail, please check the command text',
    ...
    copySettingSuccess: 'Configurations have been copied to clipboard successfully',
    shouldSelectAPISettingFirst: 'Please select API request first',
    send: 'Send',
    abort: 'Abort',
    format: 'Format',
    changeContentType: 'Change data type',
    changeContentTypeContent: 'The original data will be cleared after changing the data type, so please confirm the change',
    ...
    exportSettingsSuccess: 'The configurations are successfully exported to the download directory',
    curlTooLargeTips: 'The curl data is too large, and the content has been copied to the clipboard',
  ...
  dashboard: {
    ...
    deleteCollectionContent: 'Please confirm the deletion of API group, which can not be recovered after deletion!',
  ...
  setting: {
    ...
    dbPathPlaceholder: 'Enter a folder or file path',
    dbPathBrowse: 'Browse',
    dbPathSave: 'Save',
    dbPathSelectTitle: 'Select database directory',
    dbPathChangeSuccess: 'Database location updated, and the application will restart in 3 seconds',
    dbPathHelp: 'Supports environment variables like %OneDrive% or $HOME. You can also enter a .db file path.',
    ...
    importTablesTips: 'Restore will remove the original data. Are you sure to restore?',
    importTablesSuccess: 'Restore success, and the application will restart in 3 seconds',
    customizeVariableSetting: 'Variable',
    langChangeSuccess: 'Language configuration is modified successfully, and the application will restart in 3 seconds',
    browser: 'Browser',
    ...
    proxyListField: 'List',
    proxyListPlaceholder: 'One host or CIDR per line',
    proxyListMode: 'List mode',
    proxyModeExclude: 'Exclude list',
    proxyModeInclude: 'Include list',
    proxyEnabled: 'Enabled',
    addProxy: 'Add Proxy',
    saveProxy: 'Save',
    proxyRequired: 'Proxy can not be blank',
    proxySaveSuccess: 'Proxy saved',
    proxyDeleteConfirm: 'Delete this proxy?',
    proxyDeleteSuccess: 'Proxy deleted',
    proxyListHelp: 'Maintain multiple proxies with include/exclude lists for future routing.',
  },
  cookie: {
    title: 'Cookie',
    name: 'Name',
  ...
  envManager: {
    ...
    globalTab: 'Global Variables',
    untitledEnv: 'Untitled Environment',
    createEnv: 'Create Environment',
    editEnv: 'Edit Environment',
    deleteEnv: 'Delete Environment',
    deleteEnvTips: 'Please confirm the deletion of environment (%s)',
    envName: 'Environment Name',
    envNamePlaceholder: 'Please enter environment name',
  ...
  store: {
    ...
    settingStoreDesc: 'Save configurations such as application window, theme and etc.',
    ...
    clearTips: 'Please confirm the clearing (%s) of all data, which can not be recovered after clearing',
    clearSuccess: 'The stored data has been cleared, and the application will restart in 3 seconds',
