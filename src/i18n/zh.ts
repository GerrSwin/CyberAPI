export default {
  collection: {
    ...
    importFromCURL: '从curl导入请求',
    curlPlaceholder: '粘贴curl命令（支持Windows/POSIX）',
    curlParseFail: 'curl解析失败，请检查命令内容',
    newFolder: '新建目录',
    deleteSetting: '删除配置',
    ...
    changeContentTypeContent: '更换数据类型后原有的数据会清除，请确认是否要更换？',
    namePlaceholder: '名称',
    valuePlaceholder: '值',
    requesting: '请求中...',
    copyAsCURL: '复制为curl',
  ...
  setting: {
    ...
    dir: '数据库目录',
    dbPathPlaceholder: '请输入文件夹或文件路径',
    dbPathBrowse: '选择',
    dbPathSave: '保存',
    dbPathSelectTitle: '选择数据库目录',
    dbPathChangeSuccess: '数据库目录已更新，应用将在3秒后重启',
    dbPathHelp: '支持环境变量，如 %OneDrive% 或 $HOME，也可输入 .db 文件路径。',
    osVersion: '系统版本',
    windowSize: '应用窗口设置',
    windowWidth: '窗口宽度',
    ...
    proxyListField: '列表',
    proxyListPlaceholder: '每行一个主机或 CIDR',
    proxyListMode: '列表模式',
    proxyModeExclude: '排除列表',
    proxyModeInclude: '包含列表',
    proxyEnabled: '已启用',
    addProxy: '添加代理',
    saveProxy: '保存',
    proxyRequired: '代理不能为空',
    proxySaveSuccess: '代理已保存',
    proxyDeleteConfirm: '删除此代理？',
    proxyDeleteSuccess: '代理已删除',
    proxyListHelp: '通过包含/排除列表管理多个代理，用于后续路由。',
  },
  cookie: {
    title: 'Cookie设置',
    name: '名称',
  ...
  envManager: {
    ...
    editEnv: '编辑环境',
    deleteEnv: '删除环境',
    deleteEnvTips: '请确认删除环境(%s)',
    envName: '环境名称',
    envNamePlaceholder: '请输入环境名称',
    envValue: '环境值',
    envValuePlaceholder: '请输入环境值',
  },
  customizeVariable: {
    title: '自定义变量',
