...
import s from './item_dropdown.module.css'
    ...
    const handleSelect = (key: string) => {
      ...
      switch (key) {
        case HandleKey.Delete:
          {
            const content = i18nCollection('deleteSettingContent').replace('%s', name)
        ...
        case HandleKey.CopyAsCURL:
          {
            ...
            cookieStore
              .fetch()
              .then(() => {
                return convertRequestToCURL(collection, req, cookieStore.cookies)
              })
