...
export const useCustomizeStore = newVariableStore('customizeVariables', VariableCategory.Customize)

export function newVariableStore(name: string, category: VariableCategory) {
  return defineStore(name, {
    ...
    actions: {
      ...
      listEnable(): Variable[] {
        return this.variables.filter((item) => item.enabled === VariableStatus.Enabled)
      },
