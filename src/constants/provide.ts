...
export const addHTTPSettingFromCURLKey = 'addHTTPSettingFromCURL'
export const addHTTPSettingFromCURLDefaultValue = (folder: string) => {
  console.warn(`add http setting from curl is null, parent:${folder}`)
}
