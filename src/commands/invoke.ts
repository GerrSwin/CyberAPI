...
export const cmdSetDbPath = 'set_db_path'
...
export const cmdGetSettings = 'get_settings'
export const cmdSaveSettings = 'save_settings'
export const cmdClearSettings = 'clear_settings'
...
export const cmdAddProxy = 'add_proxy'
export const cmdUpdateProxy = 'update_proxy'
export const cmdDeleteProxy = 'delete_proxy'
export const cmdListProxy = 'list_proxy'
