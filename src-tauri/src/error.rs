...
impl From<http::uri::InvalidUri> for CyberAPIError {
...
impl From<hyper::http::uri::InvalidUri> for CyberAPIError {
...
impl From<hyper_socks2::Error> for CyberAPIError {
    fn from(error: hyper_socks2::Error) -> Self {
        CyberAPIError {
            message: error.to_string(),
